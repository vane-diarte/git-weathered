...
def main():
    parser = argparse.ArgumentParser(prog='Clima', description="Obten los datos del clima con el nombre de la ciudad y el pais.")
    ...
    parser.add_argument('-f', '--formato', choices=['json', 'csv', 'text'], default='text', help='Formato de salida: json, csv, o text')
